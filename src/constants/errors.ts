...
export const ERROR_CODES = {
  ...
  SSL_PINNING_FAILED: {code: 'E004', message: 'Noctura could not verify the server and did not connect', action: 'This usually means the network inspects traffic — try mobile data instead of Wi-Fi. If it continues, update the app.'},
