...
- Show the allocation **without a fixed TGE date** — copy: "claimable after TGE" (no calendar date). The user didn't want to commit to a date in the UI.
